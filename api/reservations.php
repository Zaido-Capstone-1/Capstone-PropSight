...
if ($method === 'POST') {
    ...
    if ($action === 'update_status') {
        ...
        $bkRow = mysqli_fetch_assoc(mysqli_query(
            $conn,
        ...
        try {
            ...
            if (in_array($newStatus, ['confirmed', 'active'])) {
                ...
                if ($amt > 0) {
                    $payExists = mysqli_fetch_assoc(mysqli_query(
                        $conn,
            ...
            if ($newStatus === 'completed') {
                $bkFull = mysqli_fetch_assoc(mysqli_query(
                    $conn,
            ...
            $bkExtra = mysqli_fetch_assoc(mysqli_query(
                $conn,
            ...
            if ($bkExtra) {
                ...
                $ntMsgs = [
                    ...
                    'completed' => [
                        'Stay completed — thanks for visiting!',
