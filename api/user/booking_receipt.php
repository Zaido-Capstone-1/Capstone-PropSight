...
if (!$bookingId) {
    ...
    echo '<p>Invalid booking ID.</p>'; exit;
}
...
<div class="action-bar">
  ...
  <button class="action-btn secondary" onclick="history.back()">
    <svg viewBox="0 0 24 24" style="width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:2.5;"><polyline points="15 18 9 12 15 6"/></svg>
    Back
  </button>
  <button class="action-btn primary" id="dlBtn" onclick="downloadPDF()">
    <svg viewBox="0 0 24 24" style="width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:2.5;"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
    Download PDF
  </button>
</div>
...
<div class="receipt" id="receiptCard">
  ...
  <div class="receipt-body">
    ...
    <div class="info-grid" style="margin-bottom:20px;">
      <div class="info-item"><div class="label">Full Name</div><div class="value"><?= $guestName ?></div></div>
      <div class="info-item"><div class="label">Email</div><div class="value"><?= htmlspecialchars($row['email']) ?></div></div>
      <div class="info-item"><div class="label">Phone</div><div class="value"><?= htmlspecialchars($row['phone'] ?? '—') ?></div></div>
      <div class="info-item"><div class="label">Booked On</div><div class="value"><?= $bookedOn ?></div></div>
    </div>
    ...
    <div class="info-grid" style="margin-bottom:20px;">
      <div class="info-item"><div class="label">Property</div><div class="value"><?= $propName ?></div></div>
      <div class="info-item"><div class="label">Unit</div><div class="value"><?= htmlspecialchars($unitLabel) ?></div></div>
      <div class="info-item" style="grid-column:1/-1;"><div class="label">Address</div><div class="value"><?= $propAddr ?></div></div>
    </div>
    ...
    <div class="info-grid" style="margin-bottom:20px;">
      <div class="info-item"><div class="label">Check-in</div><div class="value"><?= $checkin ?></div></div>
      <div class="info-item"><div class="label">Check-out</div><div class="value"><?= $checkout ?></div></div>
      <div class="info-item"><div class="label">Nights</div><div class="value"><?= $nights ?></div></div>
      <div class="info-item"><div class="label">Guests</div><div class="value"><?= $guests ?></div></div>
    </div>
    ...
    <div class="info-grid">
      <div class="info-item"><div class="label">Method</div><div class="value"><?= $payMethod ?></div></div>
      <div class="info-item"><div class="label">Payment Status</div>
        <div class="value" style="color:<?= $payStatus === 'Paid' ? '#16a34a' : '#d97706' ?>;"><?= $payStatus ?></div>
      </div>
      <?php if ($payDate !== '—'): ?>
      <div class="info-item"><div class="label">Payment Date</div><div class="value"><?= $payDate ?></div></div>
      <?php endif; ?>
    </div>
  ...
  <div class="receipt-footer">
    ...
    <span style="font-size:10px;margin-top:6px;display:block;">Generated on <?= date('M d, Y H:i') ?> · Booking <?= $bkRef ?></span>
  </div>
