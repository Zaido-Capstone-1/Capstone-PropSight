const blue = '#2563c4', gold = '#deaf37', grn = '#2ECC71', red = '#E74C3C';
  ...
  new Chart(document.getElementById('sourceDonut'), {
    type: 'doughnut',
    data: { labels: srcLabels, datasets: [{ data: srcData, backgroundColor: sourceColors.slice(0, srcLabels.length), borderWidth: 0, hoverOffset: 8 }] },
  ...
  new Chart(document.getElementById('revTrendChart'), {
    ...
    data: {
      ...
      datasets: [{
        ...
        fill: true, tension: .4, pointRadius: 3, spanGaps: false
      }]
    },
    options: {
      responsive: true, maintainAspectRatio: false,
