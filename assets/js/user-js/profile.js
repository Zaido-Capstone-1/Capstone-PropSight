...
function openVerifyEmailModal() { openModal('verifyEmailModal'); }
...
document.addEventListener('keydown', e => {
    if (e.key === 'Escape') { ['profilePhotoModal', 'editModal', 'uploadIdModal', 'deleteModal', 'verifyEmailModal'].forEach(closeModal); }
});
