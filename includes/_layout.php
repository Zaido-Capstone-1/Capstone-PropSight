...
$nav_items = [
    ...
    'bookings' => ['label' => 'My Bookings', 'sub' => 'View and manage reservations', 'href' => 'bookings.php', 'badge' => (function() {
    ...
    'saved' => ['label' => 'Saved Rooms', 'sub' => 'Rooms on your wishlist', 'href' => 'saved.php', 'badge' => (function() {
        global $conn; $uid=(int)$_SESSION['user_id'];
        if(!$conn) return null;
        $r=mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) AS c FROM saved_units WHERE user_id=$uid"));
        return $r['c']>0 ? (string)$r['c'] : null;
    })(), 'icon' => '<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>'],
    'loyalty' => ['label' => 'Loyalty Points', 'sub' => (function() {
        global $conn; $uid=(int)$_SESSION['user_id'];
        if(!$conn) return 'Earn points every stay';
        $r=mysqli_fetch_assoc(mysqli_query($conn,"SELECT COALESCE(SUM(points),0) AS v FROM loyalty_points WHERE user_id=$uid"));
        $pts=max(0,(int)$r['v']); $tier='Silver';
        if($pts>=5000)$tier='Diamond'; elseif($pts>=2000)$tier='Platinum'; elseif($pts>=500)$tier='Gold';
        return number_format($pts).' pts · '.$tier.' tier';
    })(), 'href' => 'loyalty.php', 'badge' => null, 'icon' => '<circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/>'],
...
<body>
    ...
    <header id="hdr">
        <a href="user-dashboard.php" class="logo">
            ...
            <span>
                <span
                    style="display:block;font-family:'Playfair Display',serif;font-weight:700;line-height:1.1;">Boracay <span class="brand-break">Accommodation</span></span>
            </span>
        </a>
        <nav>
        ...
        <div class="header-right">
            ...
            <div style="position:relative;display:inline-flex;align-items:center;">
                <button id="notifBellBtn" aria-label="Notifications"
                    ...
                    onmouseenter="this.style.background='var(--blue-50,#eff6ff)'"
        ...
        <div class="sidebar-body">
            ...
            <?php foreach ($nav_items as $key => $item):
                ...
                <a href="<?php echo $item['href']; ?>" class="sb-item<?php echo $isActive ? ' active-item' : ''; ?>">
                    <div class="sb-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><?php echo $item['icon']; ?></svg></div>
                    <div class="sb-text">
                    ...
                    <div class="sb-right">
                        ...
                        <?php elseif ($key === 'messages'): ?>
                            ...
                            <span class="sb-chevron" data-msg-chevron><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <polyline points="9 18 15 12 9 6" />
                                </svg></span>
                        <?php else: ?>
                            <span class="sb-chevron"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <polyline points="9 18 15 12 9 6" />
                                </svg></span>
                        <?php endif; ?>
                    </div>
        ...
        <?php if (!$isVerifiedSidebar): ?>
            <div class="verify-lock-banner">
                <div class="verify-lock-text">
                    Your account is not fully verified yet. Booking and support actions are disabled until you verify your Gmail.
                </div>
