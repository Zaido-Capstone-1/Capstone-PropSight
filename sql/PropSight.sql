...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2026 at 09:28 AM
...
CREATE TABLE `admin_notifications` (
  ...
  `type` varchar(30) NOT NULL COMMENT 'message, new_booking, cancellation, refund, maintenance, support_ticket, id_verification',
  `ref_id` varchar(50) NOT NULL COMMENT 'e.g. task-11, booking-5, msg-3',
  `text` text NOT NULL,
...
CREATE TABLE `units` (
  ...
  `season` enum('Peak','High','Low') NOT NULL DEFAULT 'Low',
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `phone`, `nationality`, `birthday`, `gender`, `password`, `oauth_provider`, `oauth_id`, `created_at`, `role`, `verification_status`, `id_verified`, `id_document_path`, `id_verified_at`, `id_reject_reason`, `login_attempts`, `last_attempt`, `is_locked`, `locked_until`, `is_blacklisted`, `is_active`, `last_login`, `profile_photo`, `address`) VALUES
(1, 'Marlon', 'Villegas', 'marlonvillegas00@gmail.com', '9497680949', 'Austria', NULL, NULL, '$2y$10$oo/3q3uKb1655EZ4pQ6mue/bZWZHrocA6DDkSwAeNHR0iuyoW3x1K', 'google', '115360974854624748495', '2026-05-30 13:29:44', 'admin', 'Verified', 'approved', NULL, NULL, NULL, 0, '2026-06-25 15:42:03', 0, NULL, 0, 1, NULL, NULL, 'Iloilo City');
...
ALTER TABLE `admin_notifications`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_admin_ref` (`admin_id`,`ref_id`),
...
ALTER TABLE `financial_reports`
  ...
  ADD KEY `fk_frep_generated_by` (`generated_by`);
...
ALTER TABLE `loyalty_redemptions`
  ...
  ADD KEY `fk_lr_reward` (`reward_id`);
...
ALTER TABLE `newsletter_subscribers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_newsletter_user` (`user_id`),
  ADD KEY `user_id` (`user_id`);
...
ALTER TABLE `refunds`
  ...
  ADD KEY `idx_created_at` (`created_at`),
  ADD KEY `fk_refund_invoice` (`invoice_id`);
...
--
ALTER TABLE `amenities`
  MODIFY `amenity_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `loyalty_rewards`
  MODIFY `reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `refunds`
  MODIFY `refund_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `tenants`
  MODIFY `tenant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `admin_notifications`
  ADD CONSTRAINT `fk_an_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `blocked_dates`
  ADD CONSTRAINT `fk_bd_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `booking_reviews`
  ADD CONSTRAINT `fk_br_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_br_unit` FOREIGN KEY (`unit_id`) REFERENCES `units` (`unit_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_br_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `financial_records`
  ADD CONSTRAINT `fk_fr_property` FOREIGN KEY (`property_id`) REFERENCES `properties` (`property_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `financial_reports`
--
ALTER TABLE `financial_reports`
  ADD CONSTRAINT `fk_frep_generated_by` FOREIGN KEY (`generated_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `invoices`
--
ALTER TABLE `invoices`
  ADD CONSTRAINT `fk_inv_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inv_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_inv_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`tenant_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `loyalty_redemptions`
  ADD CONSTRAINT `fk_lr_reward` FOREIGN KEY (`reward_id`) REFERENCES `loyalty_rewards` (`reward_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_lr_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `fk_msg_from` FOREIGN KEY (`from_user`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_msg_parent` FOREIGN KEY (`parent_id`) REFERENCES `messages` (`message_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_msg_to` FOREIGN KEY (`to_user`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `newsletter_subscribers`
--
ALTER TABLE `newsletter_subscribers`
  ADD CONSTRAINT `fk_newsletter_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `paymongo_payments`
  ADD CONSTRAINT `fk_pp_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pp_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `refunds`
  ...
  ADD CONSTRAINT `fk_refund_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_refund_payment` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`payment_id`) ON DELETE SET NULL,
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `fk_txn_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `fk_txn_recorded_by` FOREIGN KEY (`recorded_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;
